...
export class FieldErrorsComponent implements OnInit {
  @Input()
  public targetControl!: AbstractControl;
  ...
  private getControlName(control: AbstractControl | null) {
  ...
  private getFormArrayName(control: AbstractControl | any) {
    let controlName: string = '';
    if (control) {
  ...
  private getControlIndex(control: AbstractControl | any) {
    return (control.parent.controls as AbstractControl[]).findIndex(
      (item) => item === control
    );
  }
